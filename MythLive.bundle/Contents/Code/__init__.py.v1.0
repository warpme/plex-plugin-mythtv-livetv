...
def DisplayRecordingsSection(title, url):
    ...
    for section in list:
        ...
        try:
             ...
             videourl='http://'+MYTHTV_HOSTNAME+'/plex-livetv-feeder.php?readdata=true&file='+section['FileName']+'&client='+MACHINEID+'&verbose='+str(Prefs['mythtv_verbose'])+'&buffersize='+str(Prefs['mythtv_buffersize'])+'&contenttype='+urllib.pathname2url(Prefs['mythtv_contenttype'])+'&container='+Prefs['mythtv_container']
...
def AllChannelsSection(title, url):
    ...
    for section in list:
        ...
        try:
             MACHINEID = Request.Headers['X-Plex-Client-Identifier'];
             channelurl='http://'+MYTHTV_HOSTNAME+'/plex-livetv-feeder.php?readdata=true&chanid='+section['ChanNum']+"&client="+MACHINEID+"&verbose="+str(Prefs['mythtv_verbose'])+"&buffersize="+str(Prefs['mythtv_buffersize'])+'&contenttype='+urllib.pathname2url(Prefs['mythtv_contenttype'])+'&container='+Prefs['mythtv_container']
    ...
    if title == 'Channels Recently Watched' and 'RecentChannels' in Dict:
         ...
         for ra in ralist:
              ...
              try:
                   ...
                   MACHINEID = Request.Headers['X-Plex-Client-Identifier'];
                   channelurl='http://'+MYTHTV_HOSTNAME+'/plex-livetv-feeder.php?readdata=true&chanid='+str(ralist[i])+"&client="+MACHINEID+"&verbose="+str(Prefs['mythtv_verbose'])+"&buffersize="+str(Prefs['mythtv_buffersize'])+'&contenttype='+urllib.pathname2url(Prefs['mythtv_contenttype'])+'&container='+Prefs['mythtv_container']
    ...
    videoclip_obj = VideoClipObject(
        ...
        items = [
            MediaObject(
                ...
                container = Prefs['mythtv_container'],
                video_codec = Prefs['mythtv_video_codec'],
                audio_codec = Prefs['mythtv_audio_codec'],
                audio_channels = Prefs['mythtv_audio_channels'],
                video_resolution = resolution,
                bitrate = Prefs['mythtv_bitrate'],
